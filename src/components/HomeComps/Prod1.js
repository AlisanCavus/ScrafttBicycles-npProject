  ...
  return (
    <div className="flex w-screen max-h-screen  mobile:flex-auto mobile:flex-col-reverse">
      <div className="w-1/2 h- 1/2 flex flex-col justify-center text-center  mobile:w-full ">
        <h4 className="h-full  text-6xl font-sans font-medium text-slate-600 flex my-auto items-center align-middle self-center place-self-center text-center mobile:h-1/2 ">
          YOUR STYLE.
        </h4>
        <h4 className="h-full flex my-auto -mt-40 items-center text-slate-600 font-semibold text-6xl align-middle self-center mobile:h-1/2 mobile:mt-0">
          YOUR CHOISE.
        </h4>
        <p className="mobile:indent-2 tracking-widest w-1/2 text-xl h-full mobile:h-1/2 self-center mobile:text-sm mobile:w-1/2 mobile:mx-auto text-slate-700 mobile:hidden">
