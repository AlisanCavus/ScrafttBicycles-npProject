      ...
      <div className="flex flex-col">
        ...
        <div className="min-h-screen bg-garage bg-cover opacity-70 grid ">
          <div className="w-full min-h-full grid  justify-center text-center items-center ">
            <div>
              <h1 className=" h-2/4 drop-shadow-2xl shadow-slate-700 textarea-ghost text text-accent-content opacity-100 text-5xl font-medium tracking-widest uppercase">
